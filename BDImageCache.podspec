#
#  Be sure to run `pod spec lint BDImageCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "" => "dbronston@me.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "dbronston@me.com" }
  ...
  s.source       = { :git => "https://github.com/bytedissident/BDImageCache.git", :tag => "0.0.1" }
